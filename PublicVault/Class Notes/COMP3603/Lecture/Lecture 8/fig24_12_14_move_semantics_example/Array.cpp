...
Array::Array( Array &&arrayToMove ) noexcept// should be noexcept
     ...
     ptr( arrayToMove.ptr ) // move arrayToMove's ptr to new Array
{
   ...
   // NOTE: If object is supposed to never be empty, then
   //       instead of the next 2 lines, the size should be non zero
   //       and ptr should be made to point to a small dynamically allocated array.
   arrayToMove.size = 0; 
   arrayToMove.ptr = nullptr;  
} // end Array move constructor
