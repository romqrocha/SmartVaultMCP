...
int main()
{
   ...
   integers3 = integers4; // invokes copy assignment operator
   ...
   integers1 = std::move( integers4 ); // invokes move assignment operator
   ...
   // move contents of array returned by function getArrayByValue() into integers3
   cout << "\n\nUse move assignment to move contents "
	   << "of array returned by getArrayByValue() into integers3" << endl;
   integers3 = getArrayByValue(); // invokes move assignment operator
