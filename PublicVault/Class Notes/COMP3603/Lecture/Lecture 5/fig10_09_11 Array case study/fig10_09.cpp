...
int main()
{
   ...
   cout << "Size of Array integers1 is " 
      << integers1.getSize()
      << "\nArray after initialization:\n" << integers1; // Requires << operator to be overloaded

   // print integers2 size and contents
   cout << "\nSize of Array integers2 is " 
      << integers2.getSize()
      << "\nArray after initialization:\n" << integers2; // Requires << operator to be overloaded

   // input and print integers1 and integers2
   cout << "\nEnter 17 integers:" << endl;
   cin >> integers1 >> integers2; // Requires >> operator to be overloaded
   ...
   if (integers1 != integers2) {// Requires != operator to be overloaded
