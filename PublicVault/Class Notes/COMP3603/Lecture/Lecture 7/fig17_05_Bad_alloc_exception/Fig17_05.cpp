...
// Make sure to run as a 64 bit app
...
int main()
{
   ...
   try 
   {
      ...
      {
          ptr[i] = new double[200000000]; // may throw exception
                                                   // allocates 1.6 gigabytes bytes
/*
     // If we want to do it the old fashioned way ...
 
         ptr[i] = new(nothrow) double[200000000]; // may throw exception
                                            // allocates 1.6 gigabytes bytes
         if (ptr[i] == nullptr)
         {
             break;
...
*/
         ...
         cout << "ptr[" << i << "] points to 200,000,000 new doubles\n";
      } // end for
   } // end try
