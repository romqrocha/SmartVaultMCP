...
int main()
{
   cout << "Creating a unique_ptr object that points to an Integer object.\n";

   // "aim" unique_ptr at Integer object
   unique_ptr< Integer > ptrToInteger( new Integer( 7 ) );
   Integer* ptr = new Integer(10); // create another Integer object using a regular pointer
   ...
   cout << "\nInteger object pointed to by the regular pointer: " << ptr->getInteger() << endl;
   cout << "\nInteger after setInteger: " << ( *ptrToInteger ).getInteger()
